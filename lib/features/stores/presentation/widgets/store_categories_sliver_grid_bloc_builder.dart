...
class StoreCategoriesSliverGridBlocBuilder extends StatelessWidget {
  const StoreCategoriesSliverGridBlocBuilder({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<StoreDetailsCubit, StoreDetailsState>(
      ...
      builder: (context, state) => state.maybeWhen(
        ...
        fetchStoreCategoriesSuccess: (result) => SliverGrid.builder(
