...
class CheckoutFormBlocBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CheckoutCubit, CheckoutState>(
      buildWhen: (_, current) =>
          current is CheckLocationPermission ||
          current is LocationPermissionDenied ||
          current is GetCurrentCountryCode,
      builder: (context, state) {
        if (state is GetCurrentCountryCode) {
          return Form(
            ...
            child: FadeInDown(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                    controller:
                        context.read<CheckoutCubit>().usernameController,
                  ...
                  InkWell(
                    onTap: () =>
                        context.read<CheckoutCubit>().pickDate(context),
