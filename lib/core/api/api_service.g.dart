...
class _ApiService implements ApiService {
  ...
  Future<void> addProductToCart(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://192.168.1.10:8081/api/addProduct/${productId}',
          queryParameters: queryParameters,
          data: _data,
          cancelToken: cancelToken,
        )
  ...
  Future<void> removeProductFromCart(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://192.168.1.10:8081/api/cart/${productId}',
          queryParameters: queryParameters,
          data: _data,
          cancelToken: cancelToken,
        )
  ...
  Future<void> orderPay(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://192.168.1.10:8081/api/pay/${orderId}',
          queryParameters: queryParameters,
          data: _data,
          cancelToken: cancelToken,
        )
  ...
  @override
  Future<void> changeApiLang(ChangeApiLangParams params) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
